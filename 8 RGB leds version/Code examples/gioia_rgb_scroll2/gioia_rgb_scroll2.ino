...
gioia_rgb_scroll2.ino

scrolling animations for Gioia 8 RGB leds type
...
switch (prog) {
  case 1: //red scroll
    ...
    for (int z = scroll_spd; z >7; (z=z-(z/8))) {
      scroll1(z,1,scroll_dir);
      }
    break;
  ...
  case 7: //yellow scroll
  scroll_dir = !scroll_dir;
    for (int z = scroll_spd; z >7; (z=z-(z/8))) {
      scroll1(z,4,scroll_dir);
      }  
  break;
  ...
  case 9: //fuchsia scroll
  scroll_dir = !scroll_dir;
    for (int z = scroll_spd; z >7; (z=z-(z/8))) {
      scroll1(z,5,scroll_dir);
      }  
  break;
  ...
  case 13: //white scroll
  scroll_dir = !scroll_dir;
    for (int z = scroll_spd; z >7; (z=z-(z/8))) {
      scroll1(z,7,scroll_dir);
      } 
  break;
